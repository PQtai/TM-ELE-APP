    ...
    return (
        ...
        >
            ...
            <div className={`${stylesCustom ? stylesCustom.wrapInfoPost : styles.wrapInfoPost}`}>
                <div
                    className={`${stylesCustom ? stylesCustom.itemPostInfo : styles.itemPostInfo}`}
                >
                    <p
                        className={`${
                    ...
                    <p
                        className={`${
                            stylesCustom
                                ? stylesCustom.itemPostInfoAcreage
                                : styles.itemPostInfoAcreage
                        }`}
                    >
                    ...
                    >
                        ...
                        <p>
                            {stylesCustom ? (
                                <button className={stylesCustom.chat}>Chat</button>
                            ) : (
                                <></>
                            )}
                            <button
                            ...
                            >
                                ...
                                stateDataFavourite?.includes(data._id) ? (
                                    ...
                                    <FavoriteBorderIcon
                                        className={`${
                                            stylesCustom ? stylesCustom.active : styles.active
                                        }`}
                                    />
                                )}
                            </button>
                ...
                >
                    {data.userId.avatar ? (
                        <img
                            className={`${
                                stylesCustom
                                    ? stylesCustom.itemPostInfoAvatar
                                    : styles.itemPostInfoAvatar
                            }`}
                    ...
                    <p
                        className={`${
                            stylesCustom ? stylesCustom.infoAddress : styles.infoAddress
                        }`}
                    >
