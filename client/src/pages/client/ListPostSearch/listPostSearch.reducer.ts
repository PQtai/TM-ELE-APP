...
const initialState: IInitState = {
    ...
    infoFilter: {
        ...
        typePost: '',
        typeCategory: '',
        filterPrice: [0, 200000000],
        filterAcreage: [5, 1000],
        title: '',
    },
    stateAddress: {
        codeParent: '',
...
const postListSearchSlice = createSlice({
    ...
    reducers: {
        ...
        setInfoFilterPriceAndAcreage: (state, action) => {
            return {
                ...state,
                infoFilter: {
                    ...state.infoFilter,
                    filterPrice: action.payload.price,
                    filterAcreage: action.payload.acreage,
                },
            };
        },
        setInfoSearch: (state, action) => {
            return {
                ...state,
                infoFilter: {
                    ...state.infoFilter,
