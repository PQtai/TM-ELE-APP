...
import { getPostListSearch, resetInfoFilter } from './listPostSearch.reducer';
...
const ListPostSearch = () => {
   ...
   useEffect(() => {
      dispatch(getPostListSearch({ province, district, wards, typePost, typeCategory }));
   }, [province, district, wards, typePost, typeCategory]);
         ...
         <div className={styles.ListPostSearch}>
            <div className={styles.search}>
               <div className={styles.searchWrap}>
                  <input type="text" placeholder="Tìm kiếm thông tin nhà ở, trọ..." />
                              ...
                              <div className={`${styles.headOptionList}`}>
                                 <button
                                    onClick={(e) => {
                                       ...
                                       handleActiveFilterHead(target.parentElement?.parentElement);
                                    }}
                                 >
                                    Tin mới trước
                                 </button>
