...
const FormRest = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (dataCreatePost) => {
            let newData = {};
            if (dataCreatePost.deposit) {
                newData = dataCreatePost;
            } else {
                const { deposit, ...rest } = dataCreatePost;
                newData = rest;
            }

            const infoPostFormat = {
                ...newData,
                price: parseInt(dataCreatePost.price.replace(/,/g, '')),
                deposit: parseInt(dataCreatePost.deposit.replace(/,/g, '')),
            };

            // Xóa các giá trị null trong đối tượng infoPostFormat
            const filteredInfoPostFormat = Object.entries(infoPostFormat)
